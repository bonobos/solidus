# TODO this is the old module to get rid of
# called via solidus_auth_devise gem
# which aparently finds core/app/models/spree/user_address first
# noticed when trying to boot up spree-backend app
module Spree
  module UserAddress
